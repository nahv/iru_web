...
var aboutScene = new ScrollMagic.Scene({
  ...
  .on('progress', function (e) {
    ...
    var gradientColors = 'linear-gradient(180deg, rgba(255, 255, 255, 1), rgba(232, 70, 59, 1), rgba(237, 187, 28, 1), rgba(255, 255, 255, 1), rgba(0, 0, 0, 1), rgba(0, 0, 0, 0) ' + scrollPos + '%)';
